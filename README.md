...
- **Agendar** — o site já identifica o professor(a) pelo login (cadastro de nome/Componente Curricular só na primeira vez); data com nome do dia da semana ao lado (ex.: "Segunda-feira"); janela de agendamento rolante de duas semanas fechando sempre na sexta-feira anterior, e o mês seguinte inteiro é liberado 8 dias antes de ele começar (ver `calcularLimites` em `Agendar.jsx`); kit (🔴 vermelho / 🔵 azul / 🟡 amarelo) — no Kit Vermelho (restrito à Sala Maker) é possível informar manualmente a turma; períodos do dia separados em blocos **Matutino** e **Vespertino**, cada horário com fundo verde esmaecido (livre) ou vermelho esmaecido (reservado/bloqueado); cancelamento dos próprios agendamentos.
- **Grade da semana** — uma tabela por kit (Vermelho, Azul, Amarelo), empilhadas, cada período identificado com o turno (manhã/tarde); células com fundo verde esmaecido quando livres e vermelho esmaecido quando ocupadas/bloqueadas — as reservas automáticas do Projeto Maker aparecem num vermelho ainda mais forte para se destacar das demais; uma linha divisória espessa separa visualmente manhã e tarde; colunas de Segunda a Sexta com largura fixa e igual.
